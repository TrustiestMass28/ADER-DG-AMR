...
def get_convergence(p):
    ...
    #    2: [0.002070116474892325, 0.00089992333618278653 ,0.00012443509770224882,2.127001466910093e-05,9.0598437974788722e-06]  
    #}
    ...
    #Multi level - continuous refinement (every 0.1s)
    p_E = {2:[0.0065278464577034796,0.0011023970814282044, 6.959679923363609e-05, 7.6752757712181714e-06]}
